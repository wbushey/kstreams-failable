...
import org.apache.kafka.failableTestSupport.TestTopology;
...
public class FailableTopologyTestDriver<K, V> implements FailableTestDriver<K, V> {
    ...
    public FailableTopologyTestDriver(TestTopology<K, V> testTopology, Properties streamsProps){
