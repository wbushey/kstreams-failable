...
public class FailableProcessorTestDriver<K, V> implements FailableTestDriver<K, V> {
    ...
    public FailableProcessorTestDriver(MockCallback<K, V> mockCallback, Properties topologyProps, Serde<K> keySerde, Serde<V> valueSerde) {
        ...
        this.processor = new KStreamFailableForeach<>(DEAFULT_TEST_ATTEMPTS_STORE_NAME, deadLetterNodeName, action.getCallback()).get();
