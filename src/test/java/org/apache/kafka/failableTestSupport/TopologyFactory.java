...
public class TopologyFactory<K, V> {
     ...
     */
    public Topology build(FailableForeachAction<K, V> action, String inputTopicName, Serde<K> keySerde, Serde<V> valueSerde){
        ...
        final FailableKStream<K, V> retriableStream = FailableKStream.fromKStream(kStream);
